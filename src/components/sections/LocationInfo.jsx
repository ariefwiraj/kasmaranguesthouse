...
export default function LocationInfo() {
  ...
  return (
    <section id="location" className="py-20 md:py-28 bg-gradient-to-b from-gold/10 to-white relative">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-24">
        
        {/* Card Box Wrapper */}
        <div className="bg-white/90 backdrop-blur-sm border border-white/50 shadow-xl rounded-3xl p-6 sm:p-10 lg:p-14">
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            
            {/* Map Content */}
            <div className="order-2 lg:order-2 relative rounded-2xl overflow-hidden shadow-md aspect-square md:aspect-[4/3] w-full bg-[#E8E2D9]">
            ...
            <div className="order-1 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a 
                  href={buildWhatsAppLink(null, null, siteConfig)} 
                  target="_blank" 
                  rel="noreferrer"
